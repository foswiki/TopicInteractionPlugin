...
(function() {
	...
	var plupload = {
		...
		/**
		 * File duplicate error. If the user selects the same file twice.
		 *
		 * @property FILE_DUPLICATE_ERROR
		 * @final
		 */
		FILE_DUPLICATE_ERROR : -800,
		...
		extend : function(target) {
			...
			return target;
                ...
                /**
                 * Remove whitespaces from the begining of the text.
                 *
                 * @method trim
                 ...
                 */
                trim: function( text ) {
                        return (text || "").replace( plupload._rtim, "" );
                },
                _rtrim: /^(\s|\u00A0)+|(\s|\u00A0)+$/g,

                /**
                 * Create a JSON object from a text string.
                 *
                 * @method parseJSON
		...
		plupload.extend(this, {
			...
			init : function() {
				...
				self.bind('FilesAdded', function(up, selected_files) {
					var i, file, count = 0, extensionsRegExp, filters = settings.filters, foundCatchAll = false;
					...
					for (i = 0; i < selected_files.length; i++) {
						...
						file.status = plupload.QUEUED;
                                                ...
                                                // Same file already been queued
                                                if (up.getFileByName(file.name)) {
							up.trigger('Error', {
								code : plupload.FILE_DUPLICATE_ERROR,
								message : 'File already queued ... ignoring',
								file : file
							});
                                                        continue;
                                                }
			...
			/**
			 * Returns the specified file object by name.
			 *
			 * @method getFileByName
			 * @param {String} name File name to look for.
			 * @return {plupload.File} File object or undefined if it wasn't found;
			 */
