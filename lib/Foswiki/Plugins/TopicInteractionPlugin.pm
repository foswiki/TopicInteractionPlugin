...
sub initPlugin {
    ...
    Foswiki::Func::registerRESTHandler( 'changeproperties',
        \&restChangeProperties );
    ...
    Foswiki::Func::registerRESTHandler( 'createimagegallery',
        \&restCreateImageGallery );
    ...
    Foswiki::Plugins::JQueryPlugin::registerPlugin( "uploader",
        'Foswiki::Plugins::TopicInteractionPlugin::Uploader' );
...
sub restChangeProperties {
    ...
    return Foswiki::Plugins::TopicInteractionPlugin::Core::restChangeProperties(
        @_);
}
...
sub restCreateImageGallery {
    require Foswiki::Plugins::TopicInteractionPlugin::Core;
    return
      Foswiki::Plugins::TopicInteractionPlugin::Core::restCreateImageGallery(
        @_);
}
