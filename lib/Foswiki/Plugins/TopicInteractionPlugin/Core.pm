...
sub restChangeProperties {
    ...
    Foswiki::Plugins::TopicInteractionPlugin::Action::ChangeProperties::handle(
        $response, $params );
...
sub restDelete {
    ...
    Foswiki::Plugins::TopicInteractionPlugin::Action::DeleteAttachment::handle(
        $response, $params );
    deleteAttachmentArchives( $params->{web}, $params->{topic} );
...
sub restMove {
    ...
    Foswiki::Plugins::TopicInteractionPlugin::Action::MoveAttachment::handle(
        $response, $params );
    deleteAttachmentArchives( $params->{web}, $params->{topic} );
...
sub restUpload {
    ...
    Foswiki::Plugins::TopicInteractionPlugin::Action::UploadAttachment::handle(
        $response, $params );
    deleteAttachmentArchives( $params->{web}, $params->{topic} );
...
sub restCreateLink {
    ...
    Foswiki::Plugins::TopicInteractionPlugin::Action::CreateLinks::handle(
        $response, $params );
...
sub restCreateImageGallery {
    ...
    require
      Foswiki::Plugins::TopicInteractionPlugin::Action::CreateImageGallery;
    Foswiki::Plugins::TopicInteractionPlugin::Action::CreateImageGallery::handle(
        $response, $params );
...
sub restDownload {
    ...
    require
      Foswiki::Plugins::TopicInteractionPlugin::Action::DownloadAttachment;
    Foswiki::Plugins::TopicInteractionPlugin::Action::DownloadAttachment::handle(
        $response, $params );
...
sub restHide {
    ...
    Foswiki::Plugins::TopicInteractionPlugin::Action::HideAttachment::handle(
        $response, $params );
...
sub restUnhide {
    ...
    Foswiki::Plugins::TopicInteractionPlugin::Action::UnhideAttachment::handle(
        $response, $params );
...
sub printJSONRPC {
    ...
    $response->header(
        -status => $code ? 500 : 200,
        -type => 'text/plain'
        , # SMELL: should be 'application/json' but some browsers open a filesave dialog on that one (woops)
    );
...
sub deleteAttachmentArchives {
    ...
    foreach my $zip (@zips) {
        if ( defined(&Foswiki::Sandbox::validateAttachmentName) ) {
            $zip = Foswiki::Sandbox::untaint( $zip,
